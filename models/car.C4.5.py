def findDecision(obj): #obj[0]: 0, obj[1]: 1, obj[2]: 2, obj[3]: 3, obj[4]: 4, obj[5]: 5
   ...
   if obj[5] == 'med':
      ...
      if obj[3] == '4':
         ...
         if obj[0] == 'low':
            ...
            if obj[4] == 'small':
               ...
               # {"feature": "1", "instances": 6, "metric_value": 0.9183, "depth": 5}
               if obj[1] == 'med':
                  # {"feature": "2", "instances": 3, "metric_value": 0.9183, "depth": 6}
                  if obj[2] == '5more':
                     return 'acc'
      ...
      if obj[3] == '4':
         ...
         if obj[0] == 'med':
            # {"feature": "4", "instances": 24, "metric_value": 1.6403, "depth": 4}
            if obj[4] == 'med':
               # {"feature": "1", "instances": 10, "metric_value": 1.361, "depth": 5}
               if obj[1] == 'low':
               ...
               # {"feature": "2", "instances": 7, "metric_value": 0.9852, "depth": 5}
               if obj[2] == '2':
                  return 'unacc'
               elif obj[2] == '5more':
                  return 'acc'
               ...
               # {"feature": "1", "instances": 7, "metric_value": 0.8631, "depth": 5}
               if obj[1] == 'vhigh':
                  return 'acc'
               elif obj[1] == 'high':
                  return 'acc'

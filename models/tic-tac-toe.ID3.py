def findDecision(obj): #obj[0]: 0, obj[1]: 1, obj[2]: 2, obj[3]: 3, obj[4]: 4, obj[5]: 5, obj[6]: 6, obj[7]: 7, obj[8]: 8
   ...
   if obj[4] == 'x':
      ...
      if obj[0] == 'o':
         ...
         if obj[8] == 'o':
            # {"feature": "3", "instances": 25, "metric_value": 0.5294, "depth": 4}
            if obj[3] == 'b':
               # {"feature": "1", "instances": 9, "metric_value": 0.7642, "depth": 5}
               if obj[1] == 'x':
                  # {"feature": "5", "instances": 7, "metric_value": 0.5917, "depth": 6}
                  if obj[5] == 'o':
                     return 'positive'
                  elif obj[5] == 'b':
                     return 'positive'
                  elif obj[5] == 'x':
                     # {"feature": "2", "instances": 2, "metric_value": 1.0, "depth": 7}
                     if obj[2] == 'b':
                        return 'negative'
                     elif obj[2] == 'o':
                        return 'positive'
               ...
               # {"feature": "6", "instances": 7, "metric_value": 0.5917, "depth": 5}
               if obj[6] == 'x':
                  return 'positive'
               elif obj[6] == 'b':
                  return 'positive'
      ...
      if obj[8] == 'x':
         ...
         if obj[0] == 'x':
            ...
            if obj[7] == 'x':
               # {"feature": "1", "instances": 8, "metric_value": 0.5436, "depth": 5}
               if obj[1] == 'b':
                  return 'negative'
               elif obj[1] == 'x':
                  return 'negative'
      ...
      if obj[0] == 'x':
         ...
         if obj[6] == 'x':
            ...
            # {"feature": "3", "instances": 8, "metric_value": 0.8113, "depth": 4}
            if obj[3] == 'o':
               return 'positive'
            elif obj[3] == 'x':
               # {"feature": "5", "instances": 3, "metric_value": 0.9183, "depth": 5}
